...
public class F10Foods {
    ...
    public static final Food sugar_cookie = (new Food.Builder()).hunger(6).saturation(3).build();
    public static final Food cookie = (new Food.Builder()).hunger(6).saturation(3).build();
    public static final Food simple_meal = (new Food.Builder()).hunger(6).saturation(3).build();
    public static final Food fine_meal = (new Food.Builder()).hunger(6).saturation(3).build();
    public static final Food lavish_meal = (new Food.Builder()).hunger(6).saturation(3).build();
