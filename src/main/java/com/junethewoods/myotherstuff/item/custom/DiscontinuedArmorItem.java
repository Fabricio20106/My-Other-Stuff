...
public class DiscontinuedArmorItem extends ArmorItem {
    private final String modName;

    public DiscontinuedArmorItem(IArmorMaterial material, EquipmentSlotType slot, Properties properties, String modName) {
