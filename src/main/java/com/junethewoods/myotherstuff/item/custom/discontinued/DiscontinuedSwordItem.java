...
public class DiscontinuedSwordItem extends SwordItem {
    private final String modName;

    public DiscontinuedSwordItem(IItemTier tier, int damage, float swingSpeed, Properties properties, String modName) {
