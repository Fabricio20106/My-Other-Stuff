...
public class OtherEnglishLanguageProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add(StuffInit.music_disc_rubedo.get().getTranslationKey() + ".desc", "Lena Raine - Rubedo");
        item(StuffInit.music_disc_chrysopoeia, "Music Disc");
        add(StuffInit.music_disc_chrysopoeia.get().getTranslationKey() + ".desc", "Lena Raine - Chrysopoeia");
        item(StuffInit.music_disc_so_below, "Music Disc");
        add(StuffInit.music_disc_so_below.get().getTranslationKey() + ".desc", "Lena Raine - So Below");
        item(StuffInit.music_disc_creative, "Music Disc");
        add(StuffInit.music_disc_creative.get().getTranslationKey() + ".desc", "C418 - Creative Tracks");
        item(StuffInit.music_disc_end_high, "Music Disc");
        add(StuffInit.music_disc_end_high.get().getTranslationKey() + ".desc", "C418 - Outer End");
        item(StuffInit.music_disc_underwater, "Music Disc");
        add(StuffInit.music_disc_underwater.get().getTranslationKey() + ".desc", "C418 - Underwater Tracks");
        item(StuffInit.music_disc_blockades, "Music Disc");
        add(StuffInit.music_disc_blockades.get().getTranslationKey() + ".desc", "Muse - Blockades");
        item(StuffInit.music_disc_first_date, "Music Disc");
        add(StuffInit.music_disc_first_date.get().getTranslationKey() + ".desc", "Frad - First Date");
        item(StuffInit.music_disc_omae_wa_mu, "Music Disc");
        add(StuffInit.music_disc_omae_wa_mu.get().getTranslationKey() + ".desc", "Omae wa Mu");
        item(StuffInit.music_disc_sfos, "Music Disc");
        add(StuffInit.music_disc_sfos.get().getTranslationKey() + ".desc", "Coldplay - A Sky Full of Stars");
        item(StuffInit.music_disc_traces, "Music Disc");
        add(StuffInit.music_disc_traces.get().getTranslationKey() + ".desc", "Alistair Lindsay - Traces");
