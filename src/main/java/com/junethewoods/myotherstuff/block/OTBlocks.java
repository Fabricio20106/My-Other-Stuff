...
public class OTBlocks {
    ...
    public static final RegistryObject<Block> AZALEA = BLOCKS.register("azalea", () -> new AzaleaBlock(AbstractBlock.Properties.of(Material.PLANT).instabreak().sound(SoundType.GRASS).noOcclusion()));
    public static final RegistryObject<Block> FLOWERING_AZALEA = BLOCKS.register("flowering_azalea", () -> new AzaleaBlock(AbstractBlock.Properties.of(Material.PLANT).instabreak().sound(SoundType.GRASS).noOcclusion()));
