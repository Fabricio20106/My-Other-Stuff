...
public class OTBlocks {
    ...
    public static final RegistryObject<Block> SCREEN_MONITOR = BLOCKS.register("screen_monitor", () -> new MonitorBlock(AbstractBlock.Properties.of(Material.STONE).strength(1f, 1200F).sound(SoundType.NETHERITE_BLOCK).harvestTool(ToolType.PICKAXE).harvestLevel(1)));
    public static final RegistryObject<Block> MONITOR = BLOCKS.register("monitor", () -> new MonitorBlock(AbstractBlock.Properties.of(Material.STONE).strength(1f, 1200F).sound(SoundType.NETHERITE_BLOCK).harvestTool(ToolType.PICKAXE).harvestLevel(1)));
