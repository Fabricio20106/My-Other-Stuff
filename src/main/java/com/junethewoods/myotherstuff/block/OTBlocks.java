...
public class OTBlocks {
    ...
    public static final RegistryObject<Block> CRAFTER = BLOCKS.register("autocrafter", () -> new CrafterBlock(AbstractBlock.Properties.of(Material.METAL, MaterialColor.METAL).strength(5, 6).sound(SoundType.METAL)));
