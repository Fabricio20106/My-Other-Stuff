...
public class OTBlocks {
    ...
    public static final RegistryObject<Block> MOSS_CARPET = BLOCKS.register("moss_carpet", () -> new OTCarpetBlock(AbstractBlock.Properties.of(Material.PLANT, MaterialColor.COLOR_GREEN).strength(0.1F).sound(SoundType.GRASS)));
    public static final RegistryObject<Block> MOSS_BLOCK = BLOCKS.register("moss_block", () -> new MossBlock(AbstractBlock.Properties.of(Material.PLANT, MaterialColor.COLOR_GREEN).strength(0.1F).sound(SoundType.GRASS)));
