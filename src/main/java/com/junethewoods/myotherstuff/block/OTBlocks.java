...
public class OTBlocks {
    ...
    public static final RegistryObject<Block> DRAWN_COMMAND_BLOCK = BLOCKS.register("command_block_1", () -> new CommandBlockBlock(AbstractBlock.Properties.of(Material.METAL, MaterialColor.COLOR_BROWN).strength(-1, 3600000).noDrops()));
    ...
    public static final RegistryObject<Block> DRAWN_CREATIVE_ENERGY_CUBE = BLOCKS.register("energy_cube", () -> new EnergyCubeBlock(AbstractBlock.Properties.of(Material.METAL, MaterialColor.METAL).strength(5, 6).sound(SoundType.METAL)));
    public static final RegistryObject<Block> CPU = BLOCKS.register("cpu", () -> new CPUBlock(AbstractBlock.Properties.of(Material.METAL, MaterialColor.METAL).strength(5, 6).sound(SoundType.METAL)));
    public static final RegistryObject<Block> CRAFTER = BLOCKS.register("autocrafter", () -> new AutocrafterBlock(AbstractBlock.Properties.of(Material.METAL, MaterialColor.METAL).strength(5, 6).sound(SoundType.METAL)));
    ...
    public static final RegistryObject<Block> JUNGLE_BUSH_SAPLING = BLOCKS.register("oak_bush_sapling", () -> new SaplingBlock(new OakTree(), AbstractBlock.Properties.of(Material.PLANT).randomTicks().strength(0, 0).sound(SoundType.GRASS)));
    public static final RegistryObject<Block> SWAMP_OAK_SAPLING = BLOCKS.register("swamp_oak_sapling", () -> new SaplingBlock(new OakTree(), AbstractBlock.Properties.of(Material.PLANT).randomTicks().strength(0, 0).sound(SoundType.GRASS)));
    public static final RegistryObject<Block> TALL_BIRCH_SAPLING = BLOCKS.register("tall_birch_sapling", () -> new SaplingBlock(new BirchTree(), AbstractBlock.Properties.of(Material.PLANT).randomTicks().strength(0, 0).sound(SoundType.GRASS)));
    public static final RegistryObject<Block> BLUE_CARROTS = BLOCKS.register("blue_carrots", () -> new BlueCarrotBlock(AbstractBlock.Properties.of(Material.PLANT).randomTicks().strength(0, 0).sound(SoundType.CROP)));
    ...
    public static final RegistryObject<Block> DECORATED_FLOWER_POT = BLOCKS.register("orange_flower_pot", () -> new FlowerPotBlock(Blocks.AIR, AbstractBlock.Properties.of(Material.DECORATION).strength(0, 0).noOcclusion()));
    public static final RegistryObject<Block> STRIPED_DECORATED_FLOWER_POT = BLOCKS.register("orange_flower_pot_1", () -> new FlowerPotBlock(Blocks.AIR, AbstractBlock.Properties.of(Material.DECORATION).strength(0, 0).noOcclusion()));
    public static final RegistryObject<Block> DECORATED_POTTED_INNO_FLOWER = BLOCKS.register("orange_potted_inno_flower",() -> new FlowerPotBlock(INNO_FLOWER.get(), AbstractBlock.Properties.of(Material.DECORATION).strength(0, 0).noOcclusion()));
    ...
    public static final RegistryObject<Block> CRYSTAL_ORE = BLOCKS.register("crystal_ore", () -> new OreBlock(AbstractBlock.Properties.of(Material.STONE).requiresCorrectToolForDrops().strength(3, 3)));
    public static final RegistryObject<Block> DEEPSLATE_CRYSTAL_ORE = BLOCKS.register("deepslate_crystal_ore", () -> new OreBlock(AbstractBlock.Properties.of(Material.STONE, MaterialColor.COLOR_GRAY).requiresCorrectToolForDrops().strength(4.5F, 3F)));
    public static final RegistryObject<Block> CRYSTAL_BLOCK = BLOCKS.register("crystal_block", () -> new Block(AbstractBlock.Properties.of(Material.METAL, MaterialColor.QUARTZ).requiresCorrectToolForDrops().strength(5, 6).sound(SoundType.METAL)));
