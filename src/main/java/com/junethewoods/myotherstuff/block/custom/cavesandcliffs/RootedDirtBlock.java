...
public class RootedDirtBlock extends Block implements IGrowable {
    public RootedDirtBlock(Properties properties) {
        super(properties);
    }
    ...
    public void performBonemeal(ServerWorld world, Random rand, BlockPos pos, BlockState state) {
        world.setBlockAndUpdate(pos.below(), OTBlocks.HANGING_ROOTS.get().defaultBlockState());
    }
}
