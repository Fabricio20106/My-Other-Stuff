...
public class OTCarpetBlock extends Block {
    private static final VoxelShape SHAPE = Block.box(0, 0, 0, 16.0D, 1.0D, 16.0D);

    public OTCarpetBlock(Properties properties) {
        super(properties);
    }
