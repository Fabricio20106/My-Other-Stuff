...
public class OTEnglishLanguageProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        item(OTItems.WHITE_ARMS_INNOVATOR, "Original Innovator");
        ...
        item(OTItems.CARBON_BASE, "Carbon Base");
        item(OTItems.GLASS_CASING, "Glass Casing");
        item(OTItems.REDSTONE_LIPSTICK, "Redstone Lipstick");
        ...
        add(OTItems.MUSIC_DISC_CREATIVE_TRACKS.get().getDescriptionId() + ".desc", "C418 - Creative Mode OST");
        item(OTItems.MUSIC_DISC_THE_END, "Music Disc");
        add(OTItems.MUSIC_DISC_THE_END.get().getDescriptionId() + ".desc", "C418 - The End");
        item(OTItems.MUSIC_DISC_UNDERWATER_TRACKS, "Music Disc");
        add(OTItems.MUSIC_DISC_UNDERWATER_TRACKS.get().getDescriptionId() + ".desc", "C418 - Underwater OST");
