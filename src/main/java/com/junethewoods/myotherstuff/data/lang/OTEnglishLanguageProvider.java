...
public class OTEnglishLanguageProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add("itemGroup.others", "My Other Stuff");
        add("itemGroup.others.weapons", "My Other Stuff - Revived");
        ...
        item(OTItems.VILLAGER_0, "Villager (or FAKE Alan)");
        ...
        item(OTItems.ANTIQUE_DIAMOND_POWDER, "Antique Diamond Dust");
        item(OTItems.ANTIQUE_EMERALD_POWDER, "Antique Emerald Dust");
        item(OTItems.ANTIQUE_GOLD_POWDER, "Antique Gold Dust");
        item(OTItems.ANTIQUE_IRON_POWDER, "Antique Iron Dust");
        item(OTItems.ANTIQUE_REDSTONE_POWDER, "Antique Redstone Dust");
        item(OTItems.DIAMOND_POWDER, "Diamond Dust");
        item(OTItems.EMERALD_POWDER, "Emerald Dust");
        item(OTItems.QUARTZ_POWDER, "Quartz Dust");
        item(OTItems.COAL_POWDER, "Coal Dust");
        item(OTItems.REDSTONE_POWDER, "Redstone Dust");
        item(OTItems.GOLD_POWDER, "Gold Dust");
        item(OTItems.IRON_POWDER, "Iron Dust");
        item(OTItems.LAPIS_LAZULI_POWDER, "Lapis Lazuli Dust");
        item(OTItems.NETHERITE_POWDER, "Netherite Dust");
        item(OTItems.NETHERITE_SCRAP_POWDER, "Netherite Scrap Dust");
        ...
        item(OTItems.EMPRESARY_ROBE, "Empresary 2's Robe");
