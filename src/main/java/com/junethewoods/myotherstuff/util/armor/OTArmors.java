...
public enum OTArmors implements IArmorMaterial {
    AZALEA_HELM(MyOtherStuff.MOD_ID + ":alex", 15, new int[] {2, 5, 6, 2}, 50, SoundEvents.ARMOR_EQUIP_LEATHER, 3, 0, () -> Ingredient.of(Items.GREEN_WOOL)),
    ...
    SOPHRYST_ACCESSORIES_NICOLAS(MyOtherStuff.MOD_ID + ":sophryst", 15, new int[] {2, 5, 6, 2}, 50, SoundEvents.ARMOR_EQUIP_LEATHER, 3, 0, () -> Ingredient.of(OTItems.COAL_DUST.get())),
    ...
    FINN(MyOtherStuff.MOD_ID + ":finn", 15, new int[] {2, 5, 6, 2}, 50, SoundEvents.ARMOR_EQUIP_LEATHER, 3,0, () -> Ingredient.of(OTItems.REDSTONE_DUST.get())),
